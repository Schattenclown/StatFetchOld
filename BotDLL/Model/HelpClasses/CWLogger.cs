namespace BotDLL.Model.HelpClasses
{
   internal class CwLogger
   {
      ...
      {
         if (writeLineString != null && writeLineString.Contains("CREATE TABLE IF NOT EXISTS"))
         {
         ...
         if (callerFunction != null && (callerFunction.Contains("<<") || callerFunction.Contains(">b__0>d")))
         {
