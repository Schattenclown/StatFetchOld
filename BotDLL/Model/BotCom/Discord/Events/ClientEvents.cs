...
internal class ClientEvents
{
   public static async Task Client_Ready(DiscordClient dcl, ReadyEventArgs e)
   {
      ...
      foreach (var command in commandline) Console.WriteLine($"Command {command.Value.Name} loaded.");
      Console.ForegroundColor = ConsoleColor.Green;
      Console.WriteLine("Bot ready!");
      Console.ForegroundColor = ConsoleColor.Gray;
      DiscordActivity activity = new() { Name = Bot.Custom ? Bot.CustomState : "/help", ActivityType = ActivityType.Streaming };
